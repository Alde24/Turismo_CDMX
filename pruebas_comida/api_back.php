...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $inicio = $_POST['inicio'];
    $fin = $_POST['fin'];
    $id_lugar = $_POST['id_lugar'];  // Ahora se recibe el ID del lugar en lugar de destino
    ...
    // Codificar los tipos de establecimiento
    $tipos_establecimiento_encoded = implode("+", array_map('urlencode', $establecimientos)); 

    // Construir la URL para la consulta en la API de Google Places con el ID del lugar
    $url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$id_lugar&radius=$distancia_comida&type=restaurant&key=$apiKey";
